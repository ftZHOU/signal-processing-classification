...
%
% PTFR - Parameterized time-frequency representation tools
%   FreqRange   - decide the frequency range for the PTFR 
%   get_fscoeff - obtain parameters for GWarblet
%   polylsqr    - obtain PCT parameters
%   splinefit   - fit a spline to noisy data
%   Polychirplet- Polynomial chirplet transform
%   GWarblet    - generalized Warblet Transform
%   SChirplet   - Cubic spline kerneled chirplet Transform
%   GWarblet_example - example to demonstrate the use of GWarblet and
%                      parameter esetimation 
%   PChirplet_Example -example to demonstrate the use of Polychirplet and
%                      parameter esetimation
%   SChirplet_example -example to demonstrate the use of Schirplet and
%                      parameter esetimation
